...
`r sprintf("![PCAPlus Output](%s)", cleanFilePath(cleanFilePath(cleanFilePath(cleanFilePath(theOutputDir, "BatchIdwithTSS"), "DualBatch"), "PCA-Plus"), "BatchIdwithTSS_Comp1_Comp2_Diagram.png"))`