---
title: "Using MBatch Assessments: Boxplot_AllSamplesData_Structures"
author: "Tod Casasent"
date: "`r Sys.Date()`"
...
vignette: >
  %\VignetteIndexEntry{Using MBatch Assessments: Boxplot_AllSamplesData_Structures}
...
![Dynamic Boxplot Example](boxplot_dynamic_data.PNG)

Here is an example of the static plot for a medium-sized dataset.

![Static Boxplot Example](BoxPlot_AllSample-Data_Diagram-TSS.png)


# Usage

Boxplot_AllSamplesData_Structures(theData, theTitle, theOutputPath,
...
```bash
/bea_testing/output/Boxplot_AllSamplesData_Structures$ ls -l
total 44
...
```bash
/bea_testing/output/Boxplot_AllSamplesData_Structures/AllSample-Data$ ls -l
total 6228
...
-rw-r--r-- 1 linux linux      9 Jun 19 15:12 BoxPlot_AllSample-Data_CatData-BatchId-TCGA-OR-A5J1-01A-11D-A29J-05.tsv
-rw-r--r-- 1 linux linux   7552 Jun 19 15:12 BoxPlot_AllSample-Data_CatData-BatchId-TCGA-OR-A5J2-01A-11D-A29J-05.tsv
#snipped out "CatData" files for each sample for each batch type
-rw-r--r-- 1 linux linux   6469 Jun 19 15:13 BoxPlot_AllSample-Data_CatData-TSS-TCGA-PK-A5HA-01A-11D-A29J-05.tsv
-rw-r--r-- 1 linux linux   5461 Jun 19 15:13 BoxPlot_AllSample-Data_CatData-TSS-TCGA-PK-A5HB-01A-11D-A29J-05.tsv
...
![Boxplot All Samples Data Output](/bea_testing/output/Boxplot_AllSamplesData_Structures/AllSample-Data/BoxPlot_AllSample-Data_Diagram-TSS.png)
