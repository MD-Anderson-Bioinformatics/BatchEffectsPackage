...
`r sprintf("![Boxplot All Samples Data Output](%s)", cleanFilePath(cleanFilePath(cleanFilePath(cleanFilePath(theOutputDir, "AllSample-Data"),"DATA_2022-09-09-1600"),"TEST_2022-10-10-1300"), "BoxPlot_AllSample-Data_Diagram-TSS.png"))`
