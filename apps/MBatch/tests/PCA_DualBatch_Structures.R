...
theCompareFile=cleanFilePath(compareDir, "PCA_DualBatch_Structures.tsv")
theRandomSeed=314
#myRandomSeed <- 314
#myTestSeed <- 42
theBatchType="TSS"
...
if (!is.null(inputDir))
{
  ...
  correctedMatrix <- readAsGenericMatrix(cleanFilePath(cleanFilePath(cleanFilePath(cleanFilePath(cleanFilePath(theOutputDir, "BatchIdwithPlateId"), "DualBatch"), "DATA_2022-09-09-1600"), "TEST_2022-10-10-1300"), "PCAValues.tsv"))
