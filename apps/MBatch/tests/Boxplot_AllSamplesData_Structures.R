...
theCompareFileAnn=cleanFilePath(compareDir, "BoxPlot_AllSample-Data_Annotations-TSS.tsv")
theCompareFileBox=cleanFilePath(compareDir, "BoxPlot_AllSample-Data_BoxData-TSS.tsv")
theCompareFileHis=cleanFilePath(compareDir, "BoxPlot_AllSample-Data_Histogram-TSS.tsv")
theRandomSeed=314
#myRandomSeed <- 314
#myTestSeed <- 42
#theBatchType="TSS"
...
if (!is.null(inputDir))
{
  ...
  ########################
  allSampleDataPath <- cleanFilePath(cleanFilePath(cleanFilePath(theOutputDir, "AllSample-Data"), "DATA_2022-09-09-1600"), "TEST_2022-10-10-1300")
  ########################
  correctedDataframe <- readAsGenericDataframe(cleanFilePath(allSampleDataPath, "BoxPlot_AllSample-Data_BoxData-TSS.tsv"))
  ...
  ########################
  correctedDataframe <- readAsGenericDataframe(cleanFilePath(allSampleDataPath, "BoxPlot_AllSample-Data_Annotations-TSS.tsv"))
  ...
  ########################
  correctedDataframe <- readAsGenericDataframe(cleanFilePath(allSampleDataPath, "BoxPlot_AllSample-Data_Histogram-TSS.tsv"))
