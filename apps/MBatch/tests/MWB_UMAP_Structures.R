...
theGeneFile=cleanFilePath(inputDir, "AN003501_matrix_data.tsv")
theBatchFile=cleanFilePath(inputDir, "AN003501_batches.tsv")
theOutputDir=cleanFilePath(outputDir, "MWB_UMAP")
theCompareFile=cleanFilePath(compareDir, "AN003501_UMAP_Data-batc.tsv")
print(theCompareFile)
theRandomSeed=314
theBatchType="Genotype"
