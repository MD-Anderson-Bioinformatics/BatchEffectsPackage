## ---- echo=TRUE----------------------------------------------------------
{
  ...
  theOutputDir="/bea_testing/output/Boxplot_AllSamplesData_Structures"
  theRandomSeed=314
  ...
  Boxplot_AllSamplesData_Structures(myData, "Disease/Data Type/Platform/Data Level", theOutputDir, list(), list())
}
