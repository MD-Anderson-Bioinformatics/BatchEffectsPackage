...
if (!is.null(getTestOutputDir()))
{
  ...
  # myOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "corrections"), "EB_withPara_config.tsv")
  ...
  myOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "corrections"), "EB_withPara_config_MBatch.tsv")
  myOrigGeneFile=cleanFilePath(getTestInputDirForMBatch(), "matrix_data-Tumor.tsv")
  myOrigBatchFile=cleanFilePath(getTestInputDirForMBatch(), "batches-Tumor.tsv")
  myOutputDir=cleanFilePath(baseOutputDir, "correction_EB_withPara")
