...
if (!is.null(getTestOutputDir()))
{
  ...
  # use MBatch data instead, takes less time to process
  # myOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "corrections"), "EB_withNonpara_config.tsv")
  ...
  myOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "corrections"), "EB_withNonpara_config_MBatch.tsv")
  myOrigGeneFile=cleanFilePath(getTestInputDirForMBatch(), "matrix_data-Tumor-Small.tsv")
  myOrigBatchFile=cleanFilePath(getTestInputDirForMBatch(), "batches-Tumor.tsv")
  myOutputDir=cleanFilePath(baseOutputDir, "correction_EB_withNonpara")
