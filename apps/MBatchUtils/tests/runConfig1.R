...
if (!is.null(getTestOutputDir()))
{
  ...
  theOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "runconfig1"), "MBatchConfig.tsv")
  theOrigGeneFile=cleanFilePath(cleanFilePath(baseTestDir, "runconfig1"), "matrix_data.tsv")
  theOrigBatchFile=cleanFilePath(cleanFilePath(baseTestDir, "runconfig1"), "batches.tsv")
  theOutputDir=cleanFilePath(baseOutputDir, "runconfig1")
