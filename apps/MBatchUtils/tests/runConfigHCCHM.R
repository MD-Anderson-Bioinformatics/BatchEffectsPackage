...
message("This tests a dataset with potential issues for HC and NGCHMs")
...
if (!is.null(getTestOutputDir()))
{
  ...
  theOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "hc_ngchm_issues"), "MBatchConfig.tsv")
  theOrigGeneFile=cleanFilePath(cleanFilePath(baseTestDir, "hc_ngchm_issues"), "hcissues_matrix.tsv")
  theOrigBatchFile=cleanFilePath(cleanFilePath(baseTestDir, "hc_ngchm_issues"), "hcissues_batches.tsv")
