...
if (!is.null(getTestOutputDir()))
{
  ...
  theOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "mwb"), "MBatchConfig.tsv")
  theOrigGeneFile=cleanFilePath(cleanFilePath(baseTestDir, "mwb"), "mwb_matrix_data.tsv")
  theOrigBatchFile=cleanFilePath(cleanFilePath(baseTestDir, "mwb"), "mwb_batches.tsv")
  theOrigLinkFile=cleanFilePath(cleanFilePath(baseTestDir, "mwb"), "ngchm_link_map.tsv")
  theOrigRowColFile=cleanFilePath(cleanFilePath(baseTestDir, "mwb"), "row_col_types.tsv")
  theOutputDir=cleanFilePath(baseOutputDir, "ZIP_MW2")
