...
if (!is.null(getTestOutputDir()))
{
  ...
  theOutputResults=cleanFilePath(cleanFilePath(getTestOutputDir(), "errors"), "ZIP-RESULTS")
  theDataDir=cleanFilePath(cleanFilePath(getTestOutputDir(), "errors"), "ZIP-DATA")
