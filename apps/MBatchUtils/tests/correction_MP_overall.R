...
if (!is.null(getTestOutputDir()))
{
  ...
  myOrigConfigFile=cleanFilePath(cleanFilePath(baseTestDir, "corrections"), "MP_overall_config.tsv")
  ...
  myOutputDir=cleanFilePath(baseOutputDir, "correction_MP_overall")
