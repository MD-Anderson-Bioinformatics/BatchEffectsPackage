...
.onAttach <- function(libname, pkgname)
{
  ...
  packageStartupMessage(paste("Loading Conda Environment.", mbatchUtilVersion(), sep=" "))
  setGlobalMBatchEnv(getGlobalMBatchEnv())
  setGlobalMBatchErrorTest(FALSE)
  packageStartupMessage(paste("All sorting in this package requires using a Sys.setlocale(\"LC_COLLATE\",\"C\").", mbatchUtilVersion(), sep=" "))
