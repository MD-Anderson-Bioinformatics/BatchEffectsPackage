...
.onAttach <- function(libname, pkgname)
{
  ...
  packageStartupMessage(paste("Loading Conda Environment.", "DscCR", sep=" "))
  setGlobalMBatchEnv(getGlobalMBatchEnv())
  setGlobalMBatchErrorTest(FALSE)
  packageStartupMessage(paste("All sorting in this package requires using a Sys.setlocale(\"LC_COLLATE\",\"C\").", "DscCR", sep=" "))
