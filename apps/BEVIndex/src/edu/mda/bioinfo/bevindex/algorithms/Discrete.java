...
public class Discrete
{
	...
	public Discrete(File theAlgDir, MBatchIndexData theMID)
	{
		mAlgDir = theAlgDir;
		mMID = theMID;
	}
	...
	public void checkAndAddAlgorithm()
	{
		if (mAlgDir.exists())
		{
			...
			for (String bt : btSet)
			{
				...
				btDe.entry_label = bt;
				btDe.diagram_type = "discrete";
				btDe.diagram_image = "/Discrete/" + bt + "/KW_Dunns_Diagram.PNG";
